...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'josh@bysshe.co.uk',
 ...
 //   'Powered by <a href="https://github.com/lyc8503/onedrive-cf-index-ng" target="_blank" rel="noopener noreferrer">onedrive-cf-index-ng</a>. Made with ❤ by lyc8503.',
  ...
  email: 'mailto:josh@bysshe.co.uk',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/joshuaebmcguire',
    },
  ],
